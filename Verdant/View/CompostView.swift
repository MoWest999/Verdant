...
//  Verdant
//
//  Created by Kevin A. Johnson on 3/22/23.
//
...
struct CompostView: View {
    @State private var mapRegion = MKCoordinateRegion(center: CLLocationCoordinate2D(latitude: 42.31, longitude: -83.11), span: MKCoordinateSpan(latitudeDelta: 0.5, longitudeDelta: 0.1))
